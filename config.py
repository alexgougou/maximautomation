...
monkey_log = os.path.join(project_path, "monkey.log")
monkey_jar = os.path.join(project_path, "libs\monkey.jar")
framework_jar = os.path.join(project_path, "libs\\framework.jar")
...
cpu_path = os.path.join(project_path,'cpu.log')
mem_path = os.path.join(project_path, 'mem.log')
...
all_activity_path = os.path.join(project_path, 'logs\\allactivity.log')
...
report_folder = os.path.join(project_path,'report/reports')
